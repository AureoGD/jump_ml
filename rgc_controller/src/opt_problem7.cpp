...
OptProblem7::OptProblem7(ModelMatrices *Robot) : RobotMtx(Robot)
{
...
OptProblem7::~OptProblem7()
{
}

void OptProblem7::UpdateModelConstants()
{
...
void OptProblem7::DefineConstraintMtxs()
{
