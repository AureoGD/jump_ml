...
import time
from jump_modular_env.model_matrices import ModelMatrices
...
class RobotModelGA:
    ...
    def set_switch_rule(self, rule):
        self.switch_rule = rule

    def evaluate_switch_rule(self, step):
        return self.switch_rule.evaluate(step) if self.switch_rule else 0
