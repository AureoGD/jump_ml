...
class RobotModelGA:
    ...
    def __init__(self, robot_states_dict: dict, N=10):
        """
        Args:
    ...
    def ml_states(self):
        """Calculates additional derived states (link positions/velocities) for the state dictionary."""
        self.mdl.UpdateHomogTrans()  # Ensure HT matrices are up-to-date
